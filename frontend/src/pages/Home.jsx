...
const slides = [
  {
    ...
    img: 'https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=600'
  },
  {
    ...
    img: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=600'
  },
  {
    tag: 'MODERN COMFORT',
    ...
    img: 'https://images.unsplash.com/photo-1505843490538-5133c6c7d0e1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=600'
  },
  {
    tag: 'STYLE & APPAREL',
    ...
    img: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=600'
  }
];
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 0, margin: '-40px -20px' }}>
      ...
      <section style={{ ...sectionStyle, background: 'radial-gradient(circle at 80% 20%, rgba(249, 115, 22, 0.15), transparent 50%), #09090b' }}>
        <div style={heroContentStyle}>
          ...
          <h1 className="hero-title" style={{ fontSize: '4rem', color: '#fff', lineHeight: '1.1', marginBottom: '20px', fontWeight: '800' }}>
          ...
          <p style={{ fontSize: '1.3rem', color: '#a1a1aa', maxWidth: '650px', lineHeight: '1.6', marginBottom: '35px' }}>
      ...
      <section style={{ ...sectionStyle, background: 'radial-gradient(circle at bottom left, rgba(249, 115, 22, 0.12), transparent 50%), #121214' }}>
        <div style={promoCardStyle}>
          <div style={{ flex: 1 }}>
            ...
            <h2 style={{ fontSize: '3rem', color: '#fff', marginTop: '20px', lineHeight: '1.2' }}>Enjoy 30% Off on your first order</h2>
      ...
      <section style={{ ...sectionStyle, background: '#09090b' }}>
        <div style={promoCardStyle}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <h2 style={{ fontSize: '2.5rem', color: '#fff', marginTop: '15px', marginBottom: '20px' }}>Engineering a Higher Standard of Retail</h2>
